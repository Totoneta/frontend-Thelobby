...
import DescubreAmigosPage from "../page/descubreamigos/descubreamigospage";
import SolicitudDeAmistadPage from "../page/solicituddeamistadpage/solicituddeamistadpage";
